            ...
            <div className="container-xxl position-relative p-0">
                <nav className="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                    <a href="" className="navbar-brand p-0">
                        <h1 className="m-0"><img src="src/assets/img/UniversalAcademy.png" alt="not"/>Universal<span className="fs-5"> academy</span>
                        </h1>
                    </a>
                    ...
                    <div className="collapse navbar-collapse" id="navbarCollapse">
                        <div className="navbar-nav ms-auto py-0">
                            ...
                            <Link to="http://localhost:5173/contact" className="nav-item nav-link">Biz bilan bog'lanish</Link>
                        </div>
                    </div>
                </nav>
                ...
                <div className="container-xxl py-5 bg-primary hero-header mb-5">
                    <div className="container my-5 py-5 px-lg-5">
                        <div className="row g-5 py-5">
                            ...
                            <div className="col-lg-6 text-center text-lg-start">
                                <img style={{width: "880px"}} className="img-fluid " src="src/assets/img/newsletter.png" alt="not"/>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="container-xxl py-5">
                <div className="container px-lg-5">
                    ...
                    <Link to={"http://localhost:5173/learnPc"} className="row g-4 portfolio-container">
                            ...
                            <div className="position-relative rounded overflow-hidden">
                                ...
                                <div className="portfolio-overlay">
                                    <div className="mt-auto">
                                        <Link to={""} style={{fontSize: "40px"}} className="h5 d-block text-white mt-1 mb-0"
                        ...
                        <Link to={"http://localhost:5173/webProgramming"} className="col-lg-4 col-md-6 portfolio-item second wow zoomIn" data-wow-delay="0.3s">
                            <div className="position-relative rounded overflow-hidden">
                                <img className="img-fluid w-100" style={{width: "383px", height: "283px"}}
                                ...
                                <div className="portfolio-overlay">
                                    <div className="mt-auto">
                                        <Link to={"http://localhost:5173/webProgramming"} style={{fontSize: "40px"}} className="h5 d-block text-white mt-1 mb-0"
                                           >Web dasturlash</Link>
                                    </div>
                                </div>
                            </div>
                        ...
                        <Link to={"http://localhost:5173/archDesign"} className="col-lg-4 col-md-6 portfolio-item first wow zoomIn" data-wow-delay="0.6s">
                            <div className="position-relative rounded overflow-hidden">
                                <img className="img-fluid w-100" style={{width: "383px", height: "283px"}}
                        ...
                        <Link to={"http://localhost:5173/smm&mobilograph"} className="col-lg-4 col-md-6 portfolio-item second wow zoomIn" data-wow-delay="0.1s">
                            <div className="position-relative rounded overflow-hidden">
                                <img className="img-fluid w-100" style={{width: "383px", height: "283px"}}
                        ...
                        <Link to={"http://localhost:5173/3dmac&autocad"} className="col-lg-4 col-md-6 portfolio-item first wow zoomIn" data-wow-delay="0.3s">
                            <div className="position-relative rounded overflow-hidden">
                                <img className="img-fluid w-100" style={{width: "383px", height: "283px"}}
                        ...
                        <Link to={"http://localhost:5173/graphDesign"} className="col-lg-4 col-md-6 portfolio-item second wow zoomIn" data-wow-delay="0.6s">
                            <div className="position-relative rounded overflow-hidden">
                                <img className="img-fluid w-100" style={{width: "383px", height: "283px"}}
