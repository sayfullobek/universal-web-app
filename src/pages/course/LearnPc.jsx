                    ...
                    <div className="container my-5 py-5 px-lg-5">
                        <div className="row g-5 py-5">
                            <div className="col-lg-6 text-center text-lg-start">
                                <h1 style={{fontSize: "50px"}} className="text-white mb-4 animated zoomIn">KOMPYUTER
                                    SAVODXONLIGI</h1>
                            ...
                            <div className="col-lg-6 text-center text-lg-start">
                                <img className="img-fluid" style={{width: "450px", marginTop: "-20px"}}
                                     src="src/assets/img/basic-computer-training-banner-removebg-preview.png"
                                     alt="not"/>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="row my-5">
                                    <div className="col-lg-4 col-md-4 wow zoomIn">
                                        <div
                                            ...
                                            <li className={"fs-3"}>Microsoft Word</li>
                                        </div>
                                    </div>
                                    <div className="col-lg-4 col-md-4 wow zoomIn">
                                        <div
                                            className="d-flex flex-column justify-content-center text-center rounded">
                                            <li className={"fs-3"}>Microsoft Excel</li>
                                        </div>
                                    </div>
                                    <div className="col-lg-4 col-md-4 wow zoomIn">
                                        <div
                                            className="d-flex flex-column justify-content-center text-center rounded">
                                            <li className={"fs-3"}>Microsoft Pover Point</li>
                                        </div>
                                    </div>
                                </div>
                            </div>
