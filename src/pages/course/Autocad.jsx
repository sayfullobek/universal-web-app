...
import rasm1 from '/src/assets/img/Illustrator-Vector-Illustration-1-removebg-preview.png'
                ...
                <div className="container-xxl py-5 bg-primary hero-header mb-5">
                    <div className="container my-5 py-5 px-lg-5">
                        <div className="row g-5 py-5">
                            ...
                            <div className="col-lg-6 text-center text-lg-start">
                                <img className="" style={{width: "400px", marginTop: "-30px", marginLeft: "-40px"}}
                                     src={bio}
                                     alt="not"/>
                            </div>
                        </div>
                        ...
                        <div className="row g-5">
                            <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                                <div className="section-title position-relative mb-4 pb-2">
                                    <h1 className="mt-2" style={{fontSize: "30px"}}>KURSIMIZ KIMLARGA<br/> TO’G’RI
                                        KELADI</h1>
                                </div>
                                <p className="mb-4 fs-5">3DMax Autocad ni
                                    o'rganmoqchi bo'lgan barcha yoshlar uchun</p>
                ...
                <div className="container-xxl py-5">
                    <div className="container px-lg-5">
                        <div className="row g-5">
                            <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                                <div className="section-title position-relative mb-4 pb-2">
                                    <h1 className="mt-2" style={{fontSize: "30px"}}>NIMALARNI
                                        O’RGANASIZ</h1>
                                </div>
                                <div className="row my-5">
                                    <div className="col-lg-6 col-md-4 wow zoomIn">
                                        <li className={"fs-3 col-12 text-primary"}>3DMax</li>
                                    </div>
                                    <div className="col-lg-4 col-md-4 wow zoomIn">
                                        <li className={"fs-3 text-primary"}>Autocad</li>
                                    </div>
                                </div>
                            </div>
                        </div>
